...
public class VideoChunk {
    ...
    public String getEncryptedStoragePath() {
        return encryptedStoragePath;
    }

    public void setEncryptedStoragePath(String encryptedStoragePath) {
        this.encryptedStoragePath = encryptedStoragePath;
    }
